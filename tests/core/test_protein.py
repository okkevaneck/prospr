...
def test_protein_2d_moves(protein_2d):
...
def test_protein_3d_moves(protein_3d):
...
def test_protein_2d_undo_move(protein_2d):
...
def test_protein_3d_undo_move(protein_3d):
